...
function buildRouterRepairPrompt(rawOutput: unknown, parseError: unknown, normalizedCandidate: unknown, normalizedError: unknown, warnings: string[]): string {
  return [
    ...
    '- sourceBuckets: array of { "bucket": "...", "status": "required | possible | not_needed | excluded", "reason": "..." }.',
    ...
    "- Do not output searched_but_no_signal in RouterOutput; that is only a completed research bucket result state.",
