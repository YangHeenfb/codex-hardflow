...
export function buildRouterTrace(
  ...
  return {
    ...
    researchScope: output.researchScope,
    evidenceNeed: output.evidenceNeed,
    localDiagnosisRequired: output.localDiagnosisRequired,
    externalResearchRequired: output.externalResearchRequired,
    exhaustiveCoverageRequired: output.exhaustiveCoverageRequired,
