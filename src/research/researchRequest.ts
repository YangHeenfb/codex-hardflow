...
function routerOutputForRequest(request: ResearchRequest): RouterOutput {
  ...
  return {
    ...
    researchScope: request.requiredBuckets.includes("local_repo") ? "local_plus_external" : "external_exhaustive",
    evidenceNeed: "external_sources_required",
    localDiagnosisRequired: request.requiredBuckets.includes("local_repo"),
